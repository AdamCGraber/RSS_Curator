...
class Cluster(Base):
    ...
    created_with_time_window_start: Mapped[object] = mapped_column(DateTime(timezone=True), nullable=True)
    created_with_time_window_end: Mapped[object] = mapped_column(DateTime(timezone=True), nullable=True)
